...
//            System.out.println(xOffset + " " + yOffset);
            ...
            //set x bounds
            if(camera.getX() >= Const.WORLD_ORIGIN_X && camera.getX() <= Const.WORLD_END_WIDTH - Const.WINDOW_WIDTH) {
            ...
            if(camera.getX() > Const.WORLD_END_WIDTH - Const.WINDOW_WIDTH) {
                camera.setX(Const.WORLD_END_WIDTH - Const.WINDOW_WIDTH);
            }

            //set y bounds
            if(camera.getY() >= Const.WORLD_ORIGIN_Y && camera.getY() <= Const.WORLD_END_HEIGHT - Const.WINDOW_HEIGHT) {
            ...
            if(camera.getY() > Const.WORLD_END_HEIGHT - Const.WINDOW_HEIGHT) {
                camera.setY(Const.WORLD_END_HEIGHT - Const.WINDOW_HEIGHT);
            }
            xOld = event.x();
            yOld = event.y();
        }
