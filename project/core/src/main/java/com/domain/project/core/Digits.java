...
{	
    ...
    public Digits(final GroupLayer uiLayer)
    {
        ...
        Const.N0_IMAGE.addCallback(new ResourceCallback<Image>() {
            ...
            public void done(Image image) {
				digit1.setTranslation(Const.GOLD_X, Const.GOLD_Y);
				digit1.setScale(Const.GOLD_SCALE);
	...
	public void setFirstDigit(int digit) {
		if(digit1 != null)
			digit1.destroy();
	...
	public void setSecondDigit(int digit) {
		if(digit2 != null)
			digit2.destroy();
		...
		getNumberImage(digit).addCallback(new ResourceCallback<Image>() {
            @Override
            public void done(Image image) {
				digit2.setTranslation(Const.GOLD_X - 35.0f, Const.GOLD_Y);
				digit2.setScale(Const.GOLD_SCALE);
	...
	public void setThirdDigit(int digit) {
		if(digit3 != null)
			digit3.destroy();
		...
		getNumberImage(digit).addCallback(new ResourceCallback<Image>() {
            @Override
            public void done(Image image) {
				digit3.setTranslation(Const.GOLD_X - 65.0f, Const.GOLD_Y);
				digit3.setScale(Const.GOLD_SCALE);
	...
	public void setFourthDigit(int digit) {
		if(digit4 != null)
			digit4.destroy();
		...
		getNumberImage(digit).addCallback(new ResourceCallback<Image>() {
            @Override
            public void done(Image image) {
				digit4.setTranslation(Const.GOLD_X - 95.0f, Const.GOLD_Y);
				digit4.setScale(Const.GOLD_SCALE);
	...
	public Image getNumberImage(int digit) {
		switch(digit) {
